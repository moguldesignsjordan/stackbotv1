...
export default function VendorLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen bg-sb-bg">
      ...
      <aside className="hidden lg:flex lg:flex-shrink-0 w-64 bg-white border-r border-gray-100">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <main className="flex-1 p-4 md:p-6 lg:p-10 overflow-y-auto vendor-main">
          {children}
        </main>
      </div>
