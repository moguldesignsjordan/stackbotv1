    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <select
          ...
          className="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#55529d] focus:border-transparent text-sm"
        >
              ...
              {orders.map((order) => {
                ...
                return (
                  <Link
                    ...
                    className="block bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow active:scale-[0.99]"
                  >
                      ...
                      <div className="flex items-start justify-between gap-4">
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex flex-wrap items-center gap-2 mb-2">
                            <span className="font-mono font-semibold text-[#55529d] text-sm">
                              {order.orderId}
                            </span>
