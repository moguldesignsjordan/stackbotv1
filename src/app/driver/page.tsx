...
interface DriverProfile { id: string; userId?: string; isOnline?: boolean; isOnline?: boolean; name: string; email: string; phone?: string; photoURL?: string; vehicleType?: string; vehiclePlate?: string; status: DriverStatus; verified?: boolean; rating?: number; totalDeliveries?: number; currentLocation?: { lat: number; lng: number }; }
