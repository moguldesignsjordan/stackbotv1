...
interface DeliveryOrder { id: string; customerPhone?: string; trackingPin?: string; vendorPhone?: string; items?: any[]; vendorCoordinates?: { lat: number; lng: number }; customerCoordinates?: { lat: number; lng: number }; orderId: string; status: string; deliveryStatus?: string; vendorId: string; vendorName: string; vendorAddress: string; customerId: string; customerName?: string; customerAddress?: string; deliveryAddress?: any; deliveryFee: number; total?: number; itemCount?: number; orderTotal?: number; claimedAt?: any; deliveredAt?: any; createdAt?: any; }
